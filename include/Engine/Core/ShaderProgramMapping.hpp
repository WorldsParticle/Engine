...
namespace   Engine
{
    ...
    const std::map<ShaderProgramName, ShaderProgramProperty>    MappedShaderProgram = {
        ...
        {FRAMEBUFFER_SHADER_PROGRAM, {{FRAMEBUFFER_VERTEX_SHADER, FRAMEBUFFER_FRAGMENT_SHADER}}},
        {NUAGES_SHADER_PROGRAM, {{NUAGES_VERTEX_SHADER, NUAGES_FRAGMENT_SHADER}}},
        {LIGHTNINGBOLT_SHADER_PROGRAM, {{LIGHTNINGBOLT_VERTEX_SHADER, LIGHTNINGBOLT_FRAGMENT_SHADER}}}
    };
}

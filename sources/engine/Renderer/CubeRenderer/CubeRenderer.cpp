...
//    GLuint vbo;
//    QOpenGLContext::currentContext()->functions()->glGenBuffers(1, &vbo);
//    QOpenGLContext::currentContext()->functions()->glBindBuffer(GL_ARRAY_BUFFER, vbo);
//    QOpenGLContext::currentContext()->functions()->glBufferData(GL_ARRAY_BUFFER, vertices.size() * sizeof(glm::vec3), &vertices[0], GL_STATIC_DRAW);
...
//    QOpenGLContext::currentContext()->functions()->glEnableVertexAttribArray(0);
//    QOpenGLContext::currentContext()->functions()->glBindBuffer(GL_ARRAY_BUFFER, vbo);
//    QOpenGLContext::currentContext()->functions()->glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 0, (void *)0);
...
//    QOpenGLContext::currentContext()->functions()->glDisableVertexAttribArray(0);
    ...
    GLWindow::m_funcs->glGenVertexArrays(1, &VertexArrayID);
    GLWindow::m_funcs->glBindVertexArray(VertexArrayID);

...
namespace   Engine
{
    ...
    LightningBoltMaterial::LightningBoltMaterial(const std::shared_ptr<ShaderProgram> &shaderprogram) :
    ...
    LightningBoltMaterial::~LightningBoltMaterial(void) noexcept
    {
        // nothind to do.
    }
    ...
    void
    LightningBoltMaterial::bind(void) const
    {
        /*
